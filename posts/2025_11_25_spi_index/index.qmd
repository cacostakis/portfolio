...
ggplot(data = spi_model_summary,
  ...
  labs(title = "Average residual between the observed Data Development score \nand the model's predicted score",
       subtitle = "The model predict Data Development score by using the Data infrastructure \nand Services indicators only \nPositive residuals indicates that real-world scores were higher than the predicted model.",
...
``` {r, low_income_model_plot, fig.height = 10, fig.width = 12}
...
ggplot(data = spi_model_prod_sourc_low,
  ...
  geom_point() +
  facet_wrap(~income, scales ="free_y")+
  labs(title = "Low income variation: Average residual between the observed Data \nDevelopment score and the model's predicted score",
       subtitle = "The model predicts Data Development score by using the Data Products and \nSources indicators only, and was trained on low income country data only. \nPositive residuals indicates that real-world scores were higher than the predicted model.",
       x = "Average Residual between Real-world performance and model") +
  theme(axis.title.y = element_blank(),
        axis.text.y = element_text(size = 3)) +
  theme_minimal()
